...
class Order {
    ...
    static async bulkCreate(users, phones) {
        ...
        const phonesToOrdersValuesString = orders.map(
            o => {
                const arr = new Array(_.random(1, 5, false))
                .fill(null)
        ...
        return this._client.query(`INSERT INTO orders_to_products (order_id, product_id, quantity) VALUES ${phonesToOrdersValuesString};`)
